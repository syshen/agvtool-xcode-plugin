This was inspired by cocoapods-xcode-plugin (https://github.com/kattrali/cocoapods-xcode-plugin). It provides a simple wrapper of Apple's agvtool for versioning in Xcode. 
